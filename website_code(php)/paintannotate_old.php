...
$("#pbox").mousemove(function(e){
                    ...
                    // read in the json coordinate and convert the coordinate into the system coordinate
                    // transform the coordinate to match the two shapes presented in the website (they are the same shape, just the relative size and the positions are different)
                    // get the mouse position
                    // if pointpolygontest against the coordinate value is true (use the middle point in the display and the mouse position for the pointpolygon test), do the stuff below
                    // if pointpolygontest value is false, ignore the stuff below (don't let them draw outside of the boundary)
                     var x= e.pageX - xp;
                     var y = e.pageY - yp;
